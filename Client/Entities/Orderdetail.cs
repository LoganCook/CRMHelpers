...
namespace Client.Entities
{
    public class Orderdetail : Base
    {
        ...
        public Orderdetail(CRMClient conn) : base(conn)
        {
            ...
            commonFileds = new string[] { "salesorderdetailid", "_productid_value", "parentbundleid", "priceperunit", "quantity", "manualdiscountamount_base", "producttypecode", "_uomid_value", "salesorderispricelocked" };
        }
